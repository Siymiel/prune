import {
  MessageSquare, FileUp, Zap, Link, Mic,
  ArrowRight, Play, Volume2, LayoutTemplate,
  Bot, BookOpen, Leaf,
  Code2, GitBranch, Network, RefreshCw,
  StickyNote, Clock, Database, Layers, Table, SearchCode,
  CreditCard,
} from 'lucide-react';
...
export const NODE_DEFS: NodeDef[] = [
  // INPUTS
  { kind: 'text-input',  label: 'Text Input', description: 'Accept text from users or upstream nodes', icon: MessageSquare, category: 'inputs', badge: 'Input', badgeClass: 'bg-blue-500/10 text-blue-600',   iconClass: 'text-blue-500'   },
  { kind: 'files',        label: 'Files',       description: 'Upload documents, PDFs, or images',        icon: FileUp,        category: 'inputs', badge: 'Input', badgeClass: 'bg-blue-500/10 text-blue-600',   iconClass: 'text-blue-500'   },
  ...
  { kind: 'url',          label: 'URL',          description: 'Fetch and process content from a URL',    icon: Link,          category: 'inputs', badge: 'Input', badgeClass: 'bg-blue-500/10 text-blue-600',   iconClass: 'text-blue-500'   },
  ...
  // OUTPUTS
  { kind: 'output',        label: 'Output',       description: 'Return a text result to the caller',       icon: ArrowRight,     category: 'outputs', badge: 'Output', badgeClass: 'bg-emerald-500/10 text-emerald-600', iconClass: 'text-emerald-500' },
  { kind: 'action',        label: 'Action',        description: 'Execute an action and surface the result', icon: Play,           category: 'outputs', badge: 'Output', badgeClass: 'bg-emerald-500/10 text-emerald-600', iconClass: 'text-emerald-500' },
  { kind: 'audio-output', label: 'Audio Output', description: 'Convert a text response into speech',      icon: Volume2,        category: 'outputs', badge: 'Output', badgeClass: 'bg-emerald-500/10 text-emerald-600', iconClass: 'text-emerald-500' },
  ...
  { kind: 'knowledge-base', label: 'Knowledge Base', description: 'Retrieve context from your documents',   icon: BookOpen, category: 'core', badge: 'Action', badgeClass: 'bg-sky-500/10 text-sky-600',       iconClass: 'text-sky-500'     },
  ...
  // LOGIC
  { kind: 'code',         label: 'Code',         description: 'Run custom JavaScript or Python',         icon: Code2,     category: 'logic', badge: 'Logic', badgeClass: 'bg-orange-500/10 text-orange-600', iconClass: 'text-orange-500' },
  ...
  { kind: 'ai-routing',   label: 'AI Routing',   description: 'Route messages using AI classification', icon: Network,   category: 'logic', badge: 'Logic', badgeClass: 'bg-rose-500/10 text-rose-600',     iconClass: 'text-rose-500'   },
  { kind: 'loop-subflow', label: 'Loop Subflow', description: 'Iterate over a list of items',           icon: RefreshCw, category: 'logic', badge: 'Logic', badgeClass: 'bg-rose-500/10 text-rose-600',     iconClass: 'text-rose-500'   },
  ...
  { kind: 'delay',           label: 'Delay',              description: 'Pause workflow execution for a duration', icon: Clock,         category: 'utils', badge: 'Util', badgeClass: 'bg-gray-500/10 text-gray-600',     iconClass: 'text-gray-500'   },
  { kind: 'shared-memory',  label: 'Shared Memory',       description: 'Persist values across workflow runs',     icon: Database,      category: 'utils', badge: 'Util', badgeClass: 'bg-gray-500/10 text-gray-600',     iconClass: 'text-gray-500'   },
  { kind: 'vector-store',   label: 'Dynamic Vector Store', description: 'Embed and search dynamic content',      icon: Layers,        category: 'utils', badge: 'Util', badgeClass: 'bg-gray-500/10 text-gray-600',     iconClass: 'text-gray-500'   },
